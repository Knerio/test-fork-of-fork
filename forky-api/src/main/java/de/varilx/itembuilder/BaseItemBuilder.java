...
/**
 * This is the Baseclass of all {@link de.varilx.itembuilder ItemBuilder}s
 * To use this Class initialize one of the predefined {@link de.varilx.itembuilder ItemBuilder}s
...
public abstract class BaseItemBuilder<B extends BaseItemBuilder<B, M>, M extends ItemMeta> {
    ...
    /**
     * Translates and sets the name of the item using a translation key and optional arguments.
     *
    ...
    /**
     * Translates and sets the name of the item using a translation key, project, and optional arguments.
     *
     * @param key      the translation key
    ...
    /**
     * Translates and sets the name of the item using a translation key, project, locale, and optional arguments.
     *
     * @param key      the translation key
     * @param project  the project identifier
    ...
    public B translatedName(String key, String project, Locale locale, Object... args) {
        ...
        return this.editMeta(meta -> meta.customTranslationName(key, project, locale, args));
    }
    ...
    /**
     * Sets the lore of the item using a translation key and optional arguments.
     *
     * @param key   the translation key
     * @param args  optional arguments for the translation
     * @return the builder instance
    ...
    public B translatedLore(String key, Object... args) {
        ...
        return editMeta(meta -> {
            ...
            meta.translationsLore(key, args);
        });
    }

    /**
     * Sets the lore of the item using a translation key, project, and optional arguments.
     *
     * @param key      the translation key
     * @param project  the project identifier
     * @param args     optional arguments for the translation
    ...
    /**
     * Sets the lore of the item using a translation key, project, locale, and optional arguments.
     *
     * @param key      the translation key
     * @param project  the project identifier
     * @param locale   the locale for the translation
    ...
    public B translatedLore(String key, String project, Locale locale, Object... args) {
        ...
        return editMeta(meta -> {
            if (meta.lore() == null) meta.lore(new ArrayList<>());
            meta.translationsLore(key, project, locale, args);
        });
    }

    /**
     * Conditionally sets the lore of the item using a translation key and optional arguments.
     *
     * @param supplier a condition to check
     * @param key      the translation key
     * @param args     optional arguments for the translation
    ...
    public B translatedLoreIf(@NotNull Supplier<Boolean> supplier, String key, Object... args) {
        ...
        return translatedLore(key, args);
    }

    /**
     * Conditionally sets the lore of the item using a translation key, project, and optional arguments.
     *
     * @param supplier a condition to check
     * @param key      the translation key
     * @param project  the project identifier
    ...
    public B translatedLoreIf(@NotNull Supplier<Boolean> supplier, String key, String project, Object... args) {
        ...
        checkNotNull(project, "project");
        if (!supplier.get()) return (B) this;
        return translatedLore(key, project, args);
    }

    /**
     * Conditionally sets the lore of the item using a translation key, project, locale, and optional arguments.
     *
     * @param supplier a condition to check
     * @param key      the translation key
     * @param project  the project identifier
    ...
    public B translatedLoreIf(@NotNull Supplier<Boolean> supplier, String key, String project, Locale locale, Object... args) {
        ...
        checkNotNull(locale, "locale");
        if (!supplier.get()) return (B) this;
        return translatedLore(key, project, locale, args);
    }

    /**
     * Adds translated lore to the item using a translation key and optional arguments.
     *
     * @param key   the translation key
     * @param args  optional arguments for the translation
     * @return the builder instance
    ...
    public B addTranslatedLore(String key, Object... args) {
        ...
        return editMeta(m -> {
            ...
            lore.addAll(Bukkit.getVarilxCommon().getTranslationService().getDefaultComponents(key, args));
            m.lore(lore);
        });
    }

    /**
     * Adds translated lore to the item using a translation key, project, and optional arguments.
     *
     * @param key      the translation key
     * @param project  the project identifier
     * @param args     optional arguments for the translation
    ...
    /**
     * Adds translated lore to the current meta based on the provided translation key, project, locale, and arguments.
     * If the current lore is null, it initializes an empty list before adding the translated components.
     *
     * @param key the translation key, must not be null
     * @param project the project name, must not be null
     * @param locale the locale for the translation, must not be null
     * @param args optional arguments to be passed to the translation service
    ...
    public B addTranslatedLore(String key, String project, Locale locale, Object... args) {
        ...
        return editMeta(m -> {
            List<Component> lore = m.lore();
            if (lore == null) lore = new ArrayList<>();
            lore.addAll(Bukkit.getVarilxCommon().getTranslationService().getComponents(key, project, locale, args));
            m.lore(lore);
        });
    }
